...
#3 MELHORES
select nome as '3 receitas que possuem votos positivos maiores que negativos', votos_positivos,votos_negativos from receita 
order by votos_positivos desc
limit 3;

#Reeitas a serem deletada
select id_rec as 'id da receita a ser deletada', nome from receita
where ( (votos_negativo > (votos_positivos+votos_negativos)*0.70) and (votos_negativos>20));
